...
import "./chunk-24CEPMYH.js";
import "./chunk-75BLUOF4.js";
import {
  DOCUMENT
} from "./chunk-OYP4YOU2.js";
import {
  ApplicationRef,
...
function ToastBase_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("click", function ToastBase_Conditional_1_Template_button_click_0_listener() {
      ɵɵrestoreView(_r1);
...
function ToastBase_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtext(1);
    ɵɵtemplate(2, ToastBase_Conditional_2_Conditional_2_Template, 2, 1, "ng-container");
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
...
function ToastBase_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, ToastBase_Conditional_3_Conditional_0_Template, 1, 3, "div", 4)(1, ToastBase_Conditional_3_Conditional_1_Template, 2, 4, "div", 5);
  }
  if (rf & 2) {
    ɵɵnextContext();
    const _options_r3 = ɵɵreadContextLet(0);
...
function Toast_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "button", 2);
    ɵɵlistener("click", function Toast_Conditional_1_Template_button_click_0_listener() {
      ɵɵrestoreView(_r1);
      const ctx_r1 = ɵɵnextContext();
      return ɵɵresetView(ctx_r1.remove());
    });
...
function Toast_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "div");
    ɵɵtext(1);
    ɵɵtemplate(2, Toast_Conditional_2_Conditional_2_Template, 2, 1, "ng-container");
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
...
function Toast_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, Toast_Conditional_3_Conditional_0_Template, 1, 3, "div", 4)(1, Toast_Conditional_3_Conditional_1_Template, 2, 4, "div", 5);
  }
  if (rf & 2) {
    ɵɵnextContext();
    const _options_r3 = ɵɵreadContextLet(0);
...
var ToastBase = class _ToastBase {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function ToastBase_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵdeclareLet(0);
        ɵɵtemplate(1, ToastBase_Conditional_1_Template, 3, 0, "button", 0)(2, ToastBase_Conditional_2_Template, 3, 5, "div", 1)(3, ToastBase_Conditional_3_Template, 2, 1)(4, ToastBase_Conditional_4_Template, 2, 2, "div");
      }
      if (rf & 2) {
...
var Toast = class _Toast extends ToastBase {
  ...
  static ɵcmp = ɵɵdefineComponent({
    type: _Toast,
    selectors: [["", "toast-component", ""]],
    hostAttrs: ["animate.enter", "toast-in"],
    hostVars: 4,
    ...
    template: function Toast_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵdeclareLet(0);
        ɵɵtemplate(1, Toast_Conditional_1_Template, 3, 0, "button", 0)(2, Toast_Conditional_2_Template, 3, 5, "div", 1)(3, Toast_Conditional_3_Template, 2, 1)(4, Toast_Conditional_4_Template, 2, 2, "div");
      }
      if (rf & 2) {
        const _options_r4 = ɵɵstoreLet(ctx.options());
        ɵɵadvance();
